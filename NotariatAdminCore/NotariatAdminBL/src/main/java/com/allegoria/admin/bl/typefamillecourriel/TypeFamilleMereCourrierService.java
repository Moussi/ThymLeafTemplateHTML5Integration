 ...
 * @author Allégoria
 */
public interface TypeFamilleMereCourrierService {
     ...
     * @return  The deleted .
     * @throws TypeFamilleMereCourrierNotFoundException  if no  is found with the given id.
     */
     ...
     */
//    public List<TypeFamilleMereCourrier> search(String searchTerm, int pageIndex);

    /**
     * Updates the information of a .
     * @param updated   The information of the updated .
     * @return  The updated .
     * @throws TypeFamilleMereCourrierNotFoundException  if no  is found with given id.
     */
    public TypeFamilleMereCourrier update(TypeFamilleMereCourrier updated) throws NotFoundException;
}
