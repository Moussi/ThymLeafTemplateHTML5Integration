 ...
 * @author Allégoria
 */
public interface TypeSousProduitService {
     ...
     * @return  The deleted .
     * @throws TypeTypeSousProduitNotFoundException  if no  is found with the given id.
     */
    public void delete(Long Id) throws TypeTypeSousProduitNotFoundException;
     ...
     */
//    public List<TypeSousProduit> search(String searchTerm, int pageIndex);

    /**
     * Updates the information of a .
     * @param updated   The information of the updated .
     * @return  The updated .
     * @throws TypeTypeSousProduitNotFoundException  if no  is found with given id.
     */
    public TypeSousProduit update(TypeSousProduitDTO updated) throws TypeTypeSousProduitNotFoundException;
}
